...
<head>
    ...
    <link rel="stylesheet" href="/test/Public/admin/css/pintuer.css">
    <link rel="stylesheet" href="/test/Public/admin/css/admin.css">
    <script src="/test/Public/admin/js/jquery.js"></script>
    <script src="/test/Public/admin/js/pintuer.js"></script>
    <script src="/test/Public/admin/js/respond.js"></script>
    <script src="/test/Public/admin/js/admin.js"></script>
...
<body>
    <div class="lefter">
        <div class="logo"><a href="http://www.pintuer.com" target="_blank"><img src="/test/Public/admin/images/logo.png" alt="后台管理系统" /></a></div>
    </div>
        ...
        <div class="mainer">
            <div class="admin-navbar">
                ...
                <ul class="nav nav-inline admin-nav">
                    <li class="active">
                        <a href="<?php echo U('index/start');?>" class="icon-home"> 开始</a>
            ...
            <div class="xm3">
                <div class="panel border-back">
                    <div class="panel-body text-center">
                        <img src="/test/Public/admin/images/face.jpg" width="120" class="radius-circle" /><br />
                        admin
                    </div>
            ...
            <div class="xm9">
                ...
                <div class="panel">
                    ...
                    <table class="table">
                        ...
                        <tr><td align="right">程序语言：</td><td>PHP</td><td align="right">演示：</td><td><a href="demo/" target="_blank">demo/</a></td></tr>
